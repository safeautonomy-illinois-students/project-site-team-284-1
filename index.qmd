...
Here is a video of us testing lane detection in the GEM simulator


Here is a video of us testing lane detection in the GEM car



::: {.section-container}
## What Worked and Didn't Work {.section-title}
:::
...
We will try both retraining the model on data from the highbay and using more complex solutions such as YOLO to consistantly detect lane lines.
