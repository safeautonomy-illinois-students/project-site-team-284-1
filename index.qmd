...
::: {.result-card}
![Real-world waypoints generated from GPS data](static/images/real_waypoints.png)
:::

::: {.result-card}
![Waypoints mapped onto the simulator environment](static/images/sim_waypoint_map.png)
:::
...
::: {.result-card}
**Path Planning from Origin (x=0, y=0, yaw=0) of the simulation map to a Random Point on the Road**
...
::: {.result-card}
**Park-to-Drive + Path Planner Handoff: Parking Spot to Destination**

The Park-to-Drive (P2D) controller drives from an arbitrary parking spot to the first waypoint, then hands control over to the global path planner to continue to the destination.
