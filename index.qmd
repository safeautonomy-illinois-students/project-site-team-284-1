...
::: {.result-card}
![Simulation waypoints generated from simulation odometry data](static/images/sim_waypoint_map.png)
:::
...
### Park-to-Drive + Path Planner Handoff

The Park-to-Drive (P2D) controller first maneuvers the vehicle out of an arbitrary parking spot. Once the vehicle reaches the first waypoint of the global path, control is handed over to the path planner, which then guides the vehicle to its final destination.
