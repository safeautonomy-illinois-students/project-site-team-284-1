...
- **Absolute Heading via Septentrio Dual-Antenna GNSS:** ZED odometry provides only *relative* heading that resets on restart, making it unsuitable for global path planning. Instead, the Septentrio INS (`/insnavgeod`) provides absolute heading in NED convention, converted to ENU:
