...
We present a novel approach to collecting passengers that focuses on ease of use and convience. 
...
::: {.content-text}
We propose a solution which utilizes the GEM autonomous vehicle and its ____ capabilities to help move people across a parking lot.
The GEM vehicle will recognize gestures, and autonomously navigate to the passenger's location. Alternatively, a phone can be used to call the vehicle.
The vehicle will then bring them to the entrance of the building. When leaving the building the vehicle will automacitally recognize the passenger's face and return them to
the location which they were picked up from.
